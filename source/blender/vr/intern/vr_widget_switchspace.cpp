...
void Widget_SwitchSpace::render_icon(const Mat44f &t,
                                     ...
                                     bool touched)
{
  ...
  switch (Widget_Transform::transform_space) {
    case VR_UI::TRANSFORMSPACE_NORMAL: {
      VR_Draw::render_rect(
          -0.008f, 0.008f, 0.008f, -0.008f, 0.001f, 1.0f, 1.0f, VR_Draw::manip_normal_tex);
      break;
    }
    case VR_UI::TRANSFORMSPACE_LOCAL: {
      VR_Draw::render_rect(
          -0.008f, 0.008f, 0.008f, -0.008f, 0.001f, 1.0f, 1.0f, VR_Draw::manip_local_tex);
      break;
    }
    case VR_UI::TRANSFORMSPACE_GLOBAL:
    default: {
      VR_Draw::render_rect(
          -0.008f, 0.008f, 0.008f, -0.008f, 0.001f, 1.0f, 1.0f, VR_Draw::manip_global_tex);
      break;
    }
  }
}
