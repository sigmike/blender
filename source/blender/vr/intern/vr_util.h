...
class VR_Util {
 public:
  ...
  static void raycast_select_single_vertex(const Coord3Df &p,
                                           ViewContext *vc,
                                           bool extend,
                                           bool deselect);

  static void raycast_select_single_edge(const Coord3Df &p,
                                         ViewContext *vc,
                                         bool extend,
                                         bool deselect);

  static void raycast_select_single_face(const Coord3Df &p,
                                         ViewContext *vc,
                                         bool extend,
                                         bool deselect);

  static void raycast_select_single_edit(
      const Coord3Df &p, bool extend, bool deselect, bool toggle = false, bool enumerate = false);

  static void raycast_select_single(const Coord3Df &p,
                                    bool extend,
                                    bool deselect,
                                    bool toggle = false,
