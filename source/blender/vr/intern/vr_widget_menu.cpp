...
/* Colorwheel colors */
static const float c_wheel[11][4] = {{0.95f, 0.95f, 0.95f, 1.0f},
...
void Widget_Menu::drag_stop(VR_UI::Cursor &c)
{
  ...
  switch (menu_type[c.side]) {
    case MENUTYPE_AS_NAVI: {
      if (angle2 >= 0 && angle2 < PI) {
        /* Lock rotation */
        Widget_Navi::obj.nav_lock[1] = ((Widget_Navi::obj.nav_lock[1] == VR_UI::NAVLOCK_ROT) ?
                                            VR_UI::NAVLOCK_NONE :
                                            VR_UI::NAVLOCK_ROT);
      }
      else if (angle2 >= PI && angle2 < 2 * PI) {
        /* Set/lock up-axis to Blender up-axis */
        Widget_Navi::obj.nav_lock[1] = ((Widget_Navi::obj.nav_lock[1] == VR_UI::NAVLOCK_ROT_UP) ?
                                            VR_UI::NAVLOCK_NONE :
                                            VR_UI::NAVLOCK_ROT_UP);
      }
      else if (angle2 >= 2 * PI && angle2 < 3 * PI) {
        /* Lock scale */
        Widget_Navi::obj.nav_lock[2] = ((Widget_Navi::obj.nav_lock[2] == VR_UI::NAVLOCK_SCALE) ?
                                            VR_UI::NAVLOCK_NONE :
                                            VR_UI::NAVLOCK_SCALE);
      }
      else if (angle2 >= 3 * PI && angle2 < 4 * PI) {
        /* Set/lock scale 1:1 with real world */
        Widget_Navi::obj.nav_lock[2] = ((Widget_Navi::obj.nav_lock[2] ==
                                         VR_UI::NAVLOCK_SCALE_REAL) ?
                                            VR_UI::NAVLOCK_NONE :
                                            VR_UI::NAVLOCK_SCALE_REAL);
      }
      else if (angle2 >= 4 * PI || (angle2 < -3 * PI && angle2 >= -4 * PI)) {
        ...
        /* Lock translation */
        Widget_Navi::obj.nav_lock[0] = ((Widget_Navi::obj.nav_lock[0] == VR_UI::NAVLOCK_TRANS) ?
                                            VR_UI::NAVLOCK_NONE :
                                            VR_UI::NAVLOCK_TRANS);
      }
      else if (angle2 < 0 && angle2 >= -PI) {
        /* Lock up-translation */
        Widget_Navi::obj.nav_lock[0] = ((Widget_Navi::obj.nav_lock[0] == VR_UI::NAVLOCK_TRANS_UP) ?
                                            VR_UI::NAVLOCK_NONE :
                                            VR_UI::NAVLOCK_TRANS_UP);
      }
      return;
    }
    case MENUTYPE_AS_TRANSFORM: {
      ...
      if (angle2 >= 0 && angle2 < PI) {
        /* Y */
        Widget_Transform::constraint_flag[0] = 0;
        Widget_Transform::constraint_flag[1] = 1;
        Widget_Transform::constraint_flag[2] = 0;
        ...
        /* Z */
        Widget_Transform::constraint_flag[0] = 0;
        Widget_Transform::constraint_flag[1] = 0;
        Widget_Transform::constraint_flag[2] = 1;
        memcpy(Widget_Transform::snap_flag, Widget_Transform::constraint_flag, sizeof(int) * 3);
        switch (Widget_Transform::transform_mode) {
          case Widget_Transform::TRANSFORMMODE_OMNI: {
...
void Widget_Menu::render_icon(const Mat44f &t, VR_Side controller_side, bool active, bool touched)
{
  if (!VR_UI::pie_menu_active[controller_side]) {
    ...
    VR_Draw::render_rect(
        -0.009f, 0.009f, 0.009f, -0.009f, 0.001f, 1.0f, 1.0f, VR_Draw::toolsettings_tex);
    return;
  }
  ...
  if (!action_settings[controller_side]) {
    ...
    if (type == MENUTYPE_TS_ANNOTATE) {
      ...
      VR_Draw::render_rect(
          -0.0728f, 0.0728f, 0.0728f, -0.0728f, -0.005f, 1.0f, 1.0f, VR_Draw::colorwheel_menu_tex);
    }
    else {
      VR_Draw::set_color(1.0f, 1.0f, 1.0f, 0.9f);
      VR_Draw::render_rect(
          -0.1121f, 0.1121f, 0.1121f, -0.1121f, -0.005f, 1.0f, 1.0f, VR_Draw::background_menu_tex);
    }
  }
  VR_Draw::set_color(1.0f, 1.0f, 1.0f, 1.0f);
    ...
    switch (type) {
      case MENUTYPE_AS_NAVI: {
        ...
        *((Coord3Df *)t_icon.m[3]) = p_as_0;
        ...
        VR_Draw::render_rect(
            -0.006f, 0.006f, 0.006f, -0.006f, 0.001f, 1.0f, 1.0f, VR_Draw::nav_lockrot_tex);
        if (Widget_Navi::nav_lock[1] == VR_UI::NAVLOCK_ROT) {
        ...
        *((Coord3Df *)t_icon.m[3]) = p_as_4;
        ...
        VR_Draw::update_modelview_matrix(&m, 0);
        VR_Draw::render_rect(
            -0.006f, 0.006f, 0.006f, -0.006f, 0.001f, 1.0f, 1.0f, VR_Draw::nav_lockrotup_tex);
        if (Widget_Navi::nav_lock[1] == VR_UI::NAVLOCK_ROT_UP) {
          VR_Draw::set_color(c_menu_white);
        }
        else if (menu_highlight_index == 4) {
        ...
        *((Coord3Df *)t_icon.m[3]) = p_as_2;
        ...
        VR_Draw::update_modelview_matrix(&m, 0);
        VR_Draw::render_rect(
            -0.006f, 0.006f, 0.006f, -0.006f, 0.001f, 1.0f, 1.0f, VR_Draw::nav_lockscale_tex);
        if (Widget_Navi::nav_lock[2] == VR_UI::NAVLOCK_SCALE) {
          VR_Draw::set_color(c_menu_white);
        }
        else if (menu_highlight_index == 2) {
        ...
        *((Coord3Df *)t_icon.m[3]) = p_as_6;
        ...
        VR_Draw::update_modelview_matrix(&m, 0);
        VR_Draw::render_rect(
            -0.006f, 0.006f, 0.006f, -0.006f, 0.001f, 1.0f, 1.0f, VR_Draw::nav_lockscalereal_tex);
        if (Widget_Navi::nav_lock[2] == VR_UI::NAVLOCK_SCALE_REAL) {
          VR_Draw::set_color(c_menu_white);
        }
        else if (menu_highlight_index == 6) {
        ...
        /* index = 7 (exit region) */
        /* index = 5 */
        bool lock = (Widget_Navi::nav_lock[0] | Widget_Navi::nav_lock[1] ||
                     Widget_Navi::nav_lock[2]);
        if (!lock) {
          VR_Draw::set_color(c_menu_green);
        }
        ...
        *((Coord3Df *)t_icon.m[3]) = p_as_5;
        ...
        VR_Draw::update_modelview_matrix(&m, 0);
        VR_Draw::render_rect(
            -0.006f, 0.006f, 0.005f, -0.007f, 0.001f, 1.0f, 1.0f, VR_Draw::off_str_tex);
        if (!lock) {
          VR_Draw::set_color(c_menu_white);
        }
        else if (menu_highlight_index == 5) {
        ...
        *((Coord3Df *)t_icon.m[3]) = p_as_1;
        ...
        VR_Draw::update_modelview_matrix(&m, 0);
        VR_Draw::render_rect(
            -0.006f, 0.006f, 0.006f, -0.006f, 0.001f, 1.0f, 1.0f, VR_Draw::nav_locktrans_tex);
        if (Widget_Navi::nav_lock[0] == VR_UI::NAVLOCK_TRANS) {
          VR_Draw::set_color(c_menu_white);
        }
        else if (menu_highlight_index == 1) {
        ...
        *((Coord3Df *)t_icon.m[3]) = p_as_3;
        ...
        VR_Draw::update_modelview_matrix(&m, 0);
        VR_Draw::render_rect(
            -0.006f, 0.006f, 0.006f, -0.006f, 0.001f, 1.0f, 1.0f, VR_Draw::nav_locktransup_tex);
        if (Widget_Navi::nav_lock[0] == VR_UI::NAVLOCK_TRANS_UP) {
          VR_Draw::set_color(c_menu_white);
        }
        else if (menu_highlight_index == 3) {
      ...
      case MENUTYPE_AS_TRANSFORM: {
        /* Center */
        VR_Widget_Layout::ButtonBit btnbit = VR_UI::ui_type == VR_UI_TYPE_OCULUS ?
                                                 VR_Widget_Layout::BUTTONBITS_STICKS :
                                                 VR_Widget_Layout::BUTTONBITS_DPADS;
        bool center_touched = ((vr_get_obj()->controller[controller_side]->buttons_touched &
                                btnbit) != 0);
        if (VR_UI::ui_type == VR_UI_TYPE_MICROSOFT) {
          ...
          *((Coord3Df *)t_icon.m[3]) =
              VR_Widget_Layout::button_positions[vr_get_obj()->ui_type][controller_side]
                                                [VR_Widget_Layout::BUTTONID_DPAD];
          ...
          switch (Widget_Transform::transform_space) {
            case VR_UI::TRANSFORMSPACE_NORMAL: {
              VR_Draw::render_rect(
                  -0.009f, 0.009f, 0.009f, -0.009f, 0.001f, 1.0f, 1.0f, VR_Draw::manip_normal_tex);
              break;
            }
            case VR_UI::TRANSFORMSPACE_LOCAL: {
              VR_Draw::render_rect(
                  -0.009f, 0.009f, 0.009f, -0.009f, 0.001f, 1.0f, 1.0f, VR_Draw::manip_local_tex);
              break;
            }
            case VR_UI::TRANSFORMSPACE_GLOBAL:
            default: {
              VR_Draw::render_rect(
                  -0.009f, 0.009f, 0.009f, -0.009f, 0.001f, 1.0f, 1.0f, VR_Draw::manip_global_tex);
              break;
            }
          }
        ...
        if (Widget_Transform::manipulator) {
          ...
          *((Coord3Df *)t_icon.m[3]) = p_as_2;
          ...
          VR_Draw::update_modelview_matrix(&m, 0);
          VR_Draw::render_rect(
              -0.006f, 0.006f, 0.006f, -0.006f, 0.001f, 1.0f, 1.0f, VR_Draw::manip_plus_tex);
          if (menu_highlight_index == 2) {
            VR_Draw::set_color(c_menu_white);
          }
          /* index = 6 */
          ...
          *((Coord3Df *)t_icon.m[3]) = p_as_1;
          ...
          VR_Draw::update_modelview_matrix(&m, 0);
          VR_Draw::render_rect(
              -0.006f, 0.006f, 0.006f, -0.006f, 0.001f, 1.0f, 1.0f, VR_Draw::manip_minus_tex);
          if (menu_highlight_index == 1) {
            VR_Draw::set_color(c_menu_white);
          }
          /* index = 3*/
        ...
        *((Coord3Df *)t_icon.m[3]) = p_as_0;
        ...
        VR_Draw::update_modelview_matrix(&m, 0);
        VR_Draw::render_rect(
            -0.004f, 0.004f, 0.003f, -0.005f, 0.001f, 1.0f, 1.0f, VR_Draw::y_str_tex);
        if (Widget_Transform::constraint_mode == VR_UI::CONSTRAINTMODE_TRANS_Y ||
            Widget_Transform::constraint_mode == VR_UI::CONSTRAINTMODE_ROT_Y ||
            Widget_Transform::constraint_mode == VR_UI::CONSTRAINTMODE_SCALE_Y) {
          VR_Draw::set_color(c_menu_white);
        ...
        *((Coord3Df *)t_icon.m[3]) = p_as_4;
        ...
        VR_Draw::update_modelview_matrix(&m, 0);
        VR_Draw::render_rect(
            -0.005f, 0.005f, 0.004f, -0.006f, 0.001f, 1.0f, 1.0f, VR_Draw::yz_str_tex);
        if (Widget_Transform::constraint_mode == VR_UI::CONSTRAINTMODE_TRANS_YZ ||
            Widget_Transform::constraint_mode == VR_UI::CONSTRAINTMODE_SCALE_YZ) {
          VR_Draw::set_color(c_menu_white);
        }
        ...
        *((Coord3Df *)t_icon.m[3]) = p_as_2;
        ...
        VR_Draw::update_modelview_matrix(&m, 0);
        VR_Draw::render_rect(
            -0.004f, 0.004f, 0.003f, -0.005f, 0.001f, 1.0f, 1.0f, VR_Draw::z_str_tex);
        if (Widget_Transform::constraint_mode == VR_UI::CONSTRAINTMODE_TRANS_Z ||
            Widget_Transform::constraint_mode == VR_UI::CONSTRAINTMODE_ROT_Z ||
            Widget_Transform::constraint_mode == VR_UI::CONSTRAINTMODE_SCALE_Z) {
          VR_Draw::set_color(c_menu_white);
        ...
        *((Coord3Df *)t_icon.m[3]) = p_as_6;
        ...
        VR_Draw::update_modelview_matrix(&m, 0);
        VR_Draw::render_rect(
            -0.005f, 0.005f, 0.004f, -0.006f, 0.001f, 1.0f, 1.0f, VR_Draw::zx_str_tex);
        if (Widget_Transform::constraint_mode == VR_UI::CONSTRAINTMODE_TRANS_ZX ||
            Widget_Transform::constraint_mode == VR_UI::CONSTRAINTMODE_SCALE_ZX) {
          VR_Draw::set_color(c_menu_white);
        }
        ...
        *((Coord3Df *)t_icon.m[3]) = p_as_1;
        ...
        VR_Draw::update_modelview_matrix(&m, 0);
        VR_Draw::render_rect(
            -0.004f, 0.004f, 0.003f, -0.005f, 0.001f, 1.0f, 1.0f, VR_Draw::x_str_tex);
        if (Widget_Transform::constraint_mode == VR_UI::CONSTRAINTMODE_TRANS_X ||
            Widget_Transform::constraint_mode == VR_UI::CONSTRAINTMODE_ROT_X ||
            Widget_Transform::constraint_mode == VR_UI::CONSTRAINTMODE_SCALE_X) {
          VR_Draw::set_color(c_menu_white);
        ...
        *((Coord3Df *)t_icon.m[3]) = p_as_3;
        ...
        VR_Draw::update_modelview_matrix(&m, 0);
        VR_Draw::render_rect(
            -0.005f, 0.005f, 0.004f, -0.006f, 0.001f, 1.0f, 1.0f, VR_Draw::xy_str_tex);
        if (Widget_Transform::constraint_mode == VR_UI::CONSTRAINTMODE_TRANS_XY ||
            Widget_Transform::constraint_mode == VR_UI::CONSTRAINTMODE_SCALE_XY) {
          VR_Draw::set_color(c_menu_white);
        }
    ...
    switch (menu_type[controller_side]) {
      case MENUTYPE_TS_SELECT: {
        ...
        *((Coord3Df *)t_icon.m[3]) = p8_0;
        ...
        VR_Draw::render_rect(-0.005f,
                             ...
                             1.0f,
                             1.0f,
                             VR_UI::mouse_cursor_enabled ? VR_Draw::box_filled_tex :
                                                           VR_Draw::box_empty_tex);
        if (VR_UI::mouse_cursor_enabled) {
          VR_Draw::set_color(c_menu_white);
        }
        else if (menu_highlight_index == 0) {
        ...
        *((Coord3Df *)t_icon.m[3]) = p8_2;
        ...
        VR_Draw::update_modelview_matrix(&m, 0);
        VR_Draw::render_rect(
            -0.011f, 0.011f, 0.011f, -0.011f, 0.001f, 1.0f, 1.0f, VR_Draw::select_proximity_tex);
        if (VR_UI::selection_mode == VR_UI::SELECTIONMODE_PROXIMITY) {
          VR_Draw::set_color(c_menu_white);
        }
        else if (menu_highlight_index == 2) {
        ...
        *((Coord3Df *)t_icon.m[3]) = p8_1;
        ...
        VR_Draw::update_modelview_matrix(&m, 0);
        VR_Draw::render_rect(
            -0.011f, 0.011f, 0.011f, -0.011f, 0.001f, 1.0f, 1.0f, VR_Draw::select_raycast_tex);
        if (VR_UI::selection_mode == VR_UI::SELECTIONMODE_RAYCAST) {
          VR_Draw::set_color(c_menu_white);
        }
        else if (menu_highlight_index == 1) {
        ...
        *((Coord3Df *)t_icon.m[3]) = p8_stick;
        m = t_icon * t;
        VR_Draw::update_modelview_matrix(&m, 0);
        VR_Draw::render_string(menu_str.c_str(),
                               0.009f,
                               0.012f,
                               VR_HALIGN_CENTER,
                               VR_VALIGN_TOP,
      ...
      case MENUTYPE_TS_CURSOR: {
        ...
        *((Coord3Df *)t_icon.m[3]) = p8_0;
        ...
        VR_Draw::update_modelview_matrix(&m, 0);
        VR_Draw::render_rect(
            -0.009f, 0.009f, 0.009f, -0.009f, 0.001f, 1.0f, 1.0f, VR_Draw::cursor_teleport_tex);
        if (menu_highlight_index == 0) {
          VR_Draw::set_color(c_menu_white);
        }
        /* index = 4 */
        ...
        *((Coord3Df *)t_icon.m[3]) = p8_2;
        ...
        VR_Draw::update_modelview_matrix(&m, 0);
        VR_Draw::render_rect(
            -0.009f, 0.009f, 0.009f, -0.009f, 0.001f, 1.0f, 1.0f, VR_Draw::cursor_objorigin_tex);
        if (menu_highlight_index == 2) {
          VR_Draw::set_color(c_menu_white);
        }
        /* index = 6 */
        ...
        *((Coord3Df *)t_icon.m[3]) = p8_1;
        ...
        VR_Draw::update_modelview_matrix(&m, 0);
        VR_Draw::render_rect(
            -0.009f, 0.009f, 0.009f, -0.009f, 0.001f, 1.0f, 1.0f, VR_Draw::cursor_worldorigin_tex);
        if (menu_highlight_index == 1) {
          VR_Draw::set_color(c_menu_white);
        }
        /* index = 3 */
      ...
      case MENUTYPE_TS_TRANSFORM: {
        ...
        *((Coord3Df *)t_icon.m[3]) = p8_0;
        ...
        VR_Draw::render_rect(-0.005f,
                             ...
                             1.0f,
                             1.0f,
                             Widget_Transform::manipulator ? VR_Draw::box_filled_tex :
                                                             VR_Draw::box_empty_tex);
        if (Widget_Transform::manipulator) {
          VR_Draw::set_color(c_menu_white);
        }
        ...
        *((Coord3Df *)t_icon.m[3]) = p8_4;
        ...
        VR_Draw::update_modelview_matrix(&m, 0);
        VR_Draw::render_rect(
            -0.007f, 0.007f, 0.007f, -0.007f, 0.001f, 1.0f, 1.0f, VR_Draw::scale_tex);
        if (Widget_Transform::transform_mode == Widget_Transform::TRANSFORMMODE_SCALE) {
          VR_Draw::set_color(c_menu_white);
        }
        else if (menu_highlight_index == 4) {
        ...
        *((Coord3Df *)t_icon.m[3]) = p8_2;
        ...
        VR_Draw::update_modelview_matrix(&m, 0);
        VR_Draw::render_rect(
            -0.007f, 0.007f, 0.007f, -0.007f, 0.001f, 1.0f, 1.0f, VR_Draw::transform_tex);
        if (Widget_Transform::transform_mode == Widget_Transform::TRANSFORMMODE_OMNI) {
          VR_Draw::set_color(c_menu_white);
        }
        else if (menu_highlight_index == 2) {
        ...
        if (VR_UI::ui_type == VR_UI_TYPE_VIVE) {
          ...
          *((Coord3Df *)t_icon.m[3]) = p8_6;
          ...
          VR_Draw::update_modelview_matrix(&m, 0);
          VR_Draw::render_rect(
              -0.007f, 0.007f, 0.007f, -0.007f, 0.001f, 1.0f, 1.0f, VR_Draw::duplicate_tex);
          if (menu_highlight_index == 6) {
            VR_Draw::set_color(c_menu_white);
          }
          /* index = 7 (exit region) */
          ...
          *((Coord3Df *)t_icon.m[3]) = p8_5;
          ...
          VR_Draw::update_modelview_matrix(&m, 0);
          VR_Draw::render_rect(
              -0.007f, 0.007f, 0.007f, -0.007f, 0.001f, 1.0f, 1.0f, VR_Draw::delete_tex);
          if (menu_highlight_index == 5) {
            VR_Draw::set_color(c_menu_white);
          }
        }
        ...
        *((Coord3Df *)t_icon.m[3]) = p8_1;
        ...
        VR_Draw::update_modelview_matrix(&m, 0);
        VR_Draw::render_rect(
            -0.007f, 0.007f, 0.007f, -0.007f, 0.001f, 1.0f, 1.0f, VR_Draw::move_tex);
        if (Widget_Transform::transform_mode == Widget_Transform::TRANSFORMMODE_MOVE) {
          VR_Draw::set_color(c_menu_white);
        }
        else if (menu_highlight_index == 1) {
        ...
        *((Coord3Df *)t_icon.m[3]) = p8_3;
        ...
        VR_Draw::update_modelview_matrix(&m, 0);
        VR_Draw::render_rect(
            -0.007f, 0.007f, 0.007f, -0.007f, 0.001f, 1.0f, 1.0f, VR_Draw::rotate_tex);
        if (Widget_Transform::transform_mode == Widget_Transform::TRANSFORMMODE_ROTATE) {
          VR_Draw::set_color(c_menu_white);
        }
        else if (menu_highlight_index == 3) {
      ...
      case MENUTYPE_TS_MEASURE: {
        ...
        *((Coord3Df *)t_icon.m[3]) = p8_0;
        ...
        VR_Draw::update_modelview_matrix(&m, 0);
        VR_Draw::render_rect(
            -0.009f, 0.009f, 0.009f, -0.009f, 0.001f, 1.0f, 1.0f, VR_Draw::reset_tex);
        if (menu_highlight_index == 0) {
          VR_Draw::set_color(c_menu_white);
        }
        /* index = 4 */
        ...
        *((Coord3Df *)t_icon.m[3]) = p8_2;
        ...
        VR_Draw::update_modelview_matrix(&m, 0);
        VR_Draw::render_rect(
            -0.005f, 0.005f, 0.005f, -0.005f, 0.001f, 1.0f, 1.0f, VR_Draw::plus_tex);
        if (menu_highlight_index == 2) {
          VR_Draw::set_color(c_menu_white);
        }
        /* index = 6 */
        ...
        *((Coord3Df *)t_icon.m[3]) = p8_1;
        ...
        VR_Draw::update_modelview_matrix(&m, 0);
        VR_Draw::render_rect(
            -0.007f, 0.007f, 0.007f, -0.007f, 0.001f, 1.0f, 1.0f, VR_Draw::minus_tex);
        if (menu_highlight_index == 1) {
          VR_Draw::set_color(c_menu_white);
        }
        /* index = 3 */
      ...
      case MENUTYPE_TS_ADDPRIMITIVE: {
        ...
        *((Coord3Df *)t_icon.m[3]) = p12_0;
        ...
        VR_Draw::update_modelview_matrix(&m, 0);
        VR_Draw::render_rect(
            -0.009f, 0.009f, 0.009f, -0.009f, 0.001f, 1.0f, 1.0f, VR_Draw::mesh_plane_tex);
        if (Widget_AddPrimitive::primitive == Widget_AddPrimitive::PRIMITIVE_PLANE) {
          VR_Draw::set_color(c_menu_white);
        }
        else if (menu_highlight_index == 0) {
        ...
        *((Coord3Df *)t_icon.m[3]) = p12_4;
        ...
        VR_Draw::update_modelview_matrix(&m, 0);
        VR_Draw::render_rect(
            -0.009f, 0.009f, 0.009f, -0.009f, 0.001f, 1.0f, 1.0f, VR_Draw::mesh_cone_tex);
        if (Widget_AddPrimitive::primitive == Widget_AddPrimitive::PRIMITIVE_CONE) {
          VR_Draw::set_color(c_menu_white);
        }
        else if (menu_highlight_index == 4) {
        ...
        *((Coord3Df *)t_icon.m[3]) = p12_6;
        ...
        VR_Draw::update_modelview_matrix(&m, 0);
        VR_Draw::render_rect(
            -0.009f, 0.009f, 0.009f, -0.009f, 0.001f, 1.0f, 1.0f, VR_Draw::mesh_monkey_tex);
        if (Widget_AddPrimitive::primitive == Widget_AddPrimitive::PRIMITIVE_MONKEY) {
          VR_Draw::set_color(c_menu_white);
        }
        else if (menu_highlight_index == 6) {
        ...
        *((Coord3Df *)t_icon.m[3]) = p12_2;
        ...
        VR_Draw::update_modelview_matrix(&m, 0);
        VR_Draw::render_rect(
            -0.009f, 0.009f, 0.009f, -0.009f, 0.001f, 1.0f, 1.0f, VR_Draw::mesh_circle_tex);
        if (Widget_AddPrimitive::primitive == Widget_AddPrimitive::PRIMITIVE_CIRCLE) {
          VR_Draw::set_color(c_menu_white);
        }
        else if (menu_highlight_index == 2) {
        ...
        *((Coord3Df *)t_icon.m[3]) = p12_8;
        ...
        VR_Draw::update_modelview_matrix(&m, 0);
        VR_Draw::render_rect(
            -0.009f, 0.009f, 0.009f, -0.009f, 0.001f, 1.0f, 1.0f, VR_Draw::mesh_icosphere_tex);
        if (Widget_AddPrimitive::primitive == Widget_AddPrimitive::PRIMITIVE_ICOSPHERE) {
          VR_Draw::set_color(c_menu_white);
        }
        else if (menu_highlight_index == 8) {
        ...
        *((Coord3Df *)t_icon.m[3]) = p12_10;
        ...
        VR_Draw::update_modelview_matrix(&m, 0);
        VR_Draw::render_rect(
            -0.007f, 0.007f, 0.007f, -0.007f, 0.001f, 1.0f, 1.0f, VR_Draw::join_tex);
        if (menu_highlight_index == 10) {
          VR_Draw::set_color(c_menu_white);
        }
        ...
        *((Coord3Df *)t_icon.m[3]) = p12_9;
        ...
        VR_Draw::update_modelview_matrix(&m, 0);
        VR_Draw::render_rect(
            -0.007f, 0.007f, 0.007f, -0.007f, 0.001f, 1.0f, 1.0f, VR_Draw::separate_tex);
        if (menu_highlight_index == 9) {
          VR_Draw::set_color(c_menu_white);
        }
        /* index = 7 */
        ...
        *((Coord3Df *)t_icon.m[3]) = p12_7;
        ...
        VR_Draw::update_modelview_matrix(&m, 0);
        VR_Draw::render_rect(
            -0.009f, 0.009f, 0.009f, -0.009f, 0.001f, 1.0f, 1.0f, VR_Draw::mesh_uvsphere_tex);
        if (Widget_AddPrimitive::primitive == Widget_AddPrimitive::PRIMITIVE_UVSPHERE) {
          VR_Draw::set_color(c_menu_white);
        }
        else if (menu_highlight_index == 7) {
        ...
        *((Coord3Df *)t_icon.m[3]) = p12_1;
        ...
        VR_Draw::update_modelview_matrix(&m, 0);
        VR_Draw::render_rect(
            -0.009f, 0.009f, 0.009f, -0.009f, 0.001f, 1.0f, 1.0f, VR_Draw::mesh_cube_tex);
        if (Widget_AddPrimitive::primitive == Widget_AddPrimitive::PRIMITIVE_CUBE) {
          VR_Draw::set_color(c_menu_white);
        }
        else if (menu_highlight_index == 1) {
        ...
        *((Coord3Df *)t_icon.m[3]) = p12_5;
        ...
        VR_Draw::update_modelview_matrix(&m, 0);
        VR_Draw::render_rect(
            -0.009f, 0.009f, 0.009f, -0.009f, 0.001f, 1.0f, 1.0f, VR_Draw::mesh_grid_tex);
        if (Widget_AddPrimitive::primitive == Widget_AddPrimitive::PRIMITIVE_GRID) {
          VR_Draw::set_color(c_menu_white);
        }
        else if (menu_highlight_index == 5) {
        ...
        *((Coord3Df *)t_icon.m[3]) = p12_3;
        ...
        VR_Draw::update_modelview_matrix(&m, 0);
        VR_Draw::render_rect(
            -0.009f, 0.009f, 0.009f, -0.009f, 0.001f, 1.0f, 1.0f, VR_Draw::mesh_cylinder_tex);
        if (Widget_AddPrimitive::primitive == Widget_AddPrimitive::PRIMITIVE_CYLINDER) {
          VR_Draw::set_color(c_menu_white);
        }
        else if (menu_highlight_index == 3) {
        ...
        *((Coord3Df *)t_icon.m[3]) = p12_stick;
        m = t_icon * t;
        VR_Draw::update_modelview_matrix(&m, 0);
        VR_Draw::render_string(
            menu_str.c_str(), 0.009f, 0.012f, VR_HALIGN_CENTER, VR_VALIGN_TOP, 0.0f, 0.0f, 0.001f);
        break;
      }
      case MENUTYPE_TS_EXTRUDE: {
        /* index = 0 */
        ...
        *((Coord3Df *)t_icon.m[3]) = p8_0;
        ...
        VR_Draw::update_modelview_matrix(&m, 0);
        VR_Draw::render_rect(
            -0.007f, 0.007f, 0.007f, -0.007f, 0.001f, 1.0f, 1.0f, VR_Draw::extrude_normals_tex);
        if (Widget_Extrude::extrude_mode == Widget_Extrude::EXTRUDEMODE_NORMALS) {
          VR_Draw::set_color(c_menu_white);
        }
        else if (menu_highlight_index == 0) {
        ...
        *((Coord3Df *)t_icon.m[3]) = p8_4;
        ...
        VR_Draw::render_rect(-0.005f,
                             ...
                             1.0f,
                             1.0f,
                             Widget_Extrude::transform ? VR_Draw::box_filled_tex :
                                                         VR_Draw::box_empty_tex);
        if (Widget_Extrude::transform) {
          VR_Draw::set_color(c_menu_white);
        }
        ...
        *((Coord3Df *)t_icon.m[3]) = p8_2;
        ...
        VR_Draw::update_modelview_matrix(&m, 0);
        VR_Draw::render_rect(
            -0.007f, 0.007f, 0.007f, -0.007f, 0.001f, 1.0f, 1.0f, VR_Draw::extrude_individual_tex);
        if (Widget_Extrude::extrude_mode == Widget_Extrude::EXTRUDEMODE_INDIVIDUAL) {
          VR_Draw::set_color(c_menu_white);
        }
        else if (menu_highlight_index == 2) {
        ...
        *((Coord3Df *)t_icon.m[3]) = p8_1;
        ...
        VR_Draw::update_modelview_matrix(&m, 0);
        VR_Draw::render_rect(
            -0.007f, 0.007f, 0.007f, -0.007f, 0.001f, 1.0f, 1.0f, VR_Draw::extrude_tex);
        if (Widget_Extrude::extrude_mode == Widget_Extrude::EXTRUDEMODE_REGION) {
          VR_Draw::set_color(c_menu_white);
        }
        else if (menu_highlight_index == 1) {
        ...
        *((Coord3Df *)t_icon.m[3]) = p8_3;
        ...
        VR_Draw::render_rect(-0.005f,
                             ...
                             1.0f,
                             1.0f,
                             Widget_Extrude::flip_normals ? VR_Draw::box_filled_tex :
                                                            VR_Draw::box_empty_tex);
        if (Widget_Extrude::flip_normals) {
          VR_Draw::set_color(c_menu_white);
        }
      ...
      case MENUTYPE_TS_INSETFACES: {
        ...
        *((Coord3Df *)t_icon.m[3]) = p8_0;
        ...
        VR_Draw::render_rect(-0.005f,
                             ...
                             1.0f,
                             1.0f,
                             Widget_InsetFaces::use_individual ? VR_Draw::box_filled_tex :
                                                                 VR_Draw::box_empty_tex);
        if (Widget_InsetFaces::use_individual) {
          VR_Draw::set_color(c_menu_white);
        }
        ...
        *((Coord3Df *)t_icon.m[3]) = p8_4;
        ...
        VR_Draw::render_rect(-0.005f,
                             ...
                             1.0f,
                             1.0f,
                             Widget_InsetFaces::use_outset ? VR_Draw::box_filled_tex :
                                                             VR_Draw::box_empty_tex);
        if (Widget_InsetFaces::use_outset) {
          VR_Draw::set_color(c_menu_white);
        }
        ...
        *((Coord3Df *)t_icon.m[3]) = p8_2;
        ...
        VR_Draw::render_rect(-0.005f,
                             ...
                             1.0f,
                             1.0f,
                             Widget_InsetFaces::use_relative_offset ? VR_Draw::box_filled_tex :
                                                                      VR_Draw::box_empty_tex);
        if (Widget_InsetFaces::use_relative_offset) {
          VR_Draw::set_color(c_menu_white);
        }
        ...
        *((Coord3Df *)t_icon.m[3]) = p8_1;
        ...
        VR_Draw::render_rect(-0.005f,
                             ...
                             1.0f,
                             1.0f,
                             Widget_InsetFaces::use_even_offset ? VR_Draw::box_filled_tex :
                                                                  VR_Draw::box_empty_tex);
        if (Widget_InsetFaces::use_even_offset) {
          VR_Draw::set_color(c_menu_white);
        }
        ...
        *((Coord3Df *)t_icon.m[3]) = p8_3;
        ...
        VR_Draw::render_rect(-0.005f,
                             ...
                             1.0f,
                             1.0f,
                             Widget_InsetFaces::use_boundary ? VR_Draw::box_filled_tex :
                                                               VR_Draw::box_empty_tex);
        if (Widget_InsetFaces::use_boundary) {
          VR_Draw::set_color(c_menu_white);
        }
      ...
      case MENUTYPE_TS_BEVEL: {
        ...
        *((Coord3Df *)t_icon.m[3]) = p8_0;
        ...
        VR_Draw::render_rect(-0.005f,
                             ...
                             1.0f,
                             1.0f,
                             Widget_Bevel::vertex_only ? VR_Draw::box_filled_tex :
                                                         VR_Draw::box_empty_tex);
        if (Widget_Bevel::vertex_only) {
          VR_Draw::set_color(c_menu_white);
        }
      ...
      case MENUTYPE_TS_LOOPCUT: {
        ...
        *((Coord3Df *)t_icon.m[3]) = p8_0;
        ...
        VR_Draw::render_rect(-0.005f,
                             ...
                             1.0f,
                             1.0f,
                             Widget_LoopCut::edge_slide ? VR_Draw::box_filled_tex :
                                                          VR_Draw::box_empty_tex);
        if (Widget_LoopCut::edge_slide) {
          VR_Draw::set_color(c_menu_white);
        }
        ...
        *((Coord3Df *)t_icon.m[3]) = p8_4;
        ...
        VR_Draw::render_rect(-0.005f,
                             ...
                             1.0f,
                             1.0f,
                             Widget_LoopCut::clamp ? VR_Draw::box_filled_tex :
                                                     VR_Draw::box_empty_tex);
        if (Widget_LoopCut::clamp) {
          VR_Draw::set_color(c_menu_white);
        }
        ...
        *((Coord3Df *)t_icon.m[3]) = p8_3;
        ...
        VR_Draw::render_rect(-0.005f,
                             ...
                             1.0f,
                             1.0f,
                             Widget_LoopCut::flipped ? VR_Draw::box_filled_tex :
                                                       VR_Draw::box_empty_tex);
        if (Widget_LoopCut::flipped) {
          VR_Draw::set_color(c_menu_white);
        }
      ...
      case MENUTYPE_TS_KNIFE: {
        ...
        // VR_Draw::box_empty_tex); VR_Draw::set_color(c_menu_white);
        ///* index = 4 */
        ///* index = 2 */
        // if (menu_highlight_index == 2) {
        //	VR_Draw::set_color(c_menu_blue);
        ...
        // VR_Draw::update_modelview_matrix(&m, 0);
        // VR_Draw::render_rect(-0.005f, 0.005f, 0.005f, -0.005f, 0.001f, 1.0f, 1.0f,
        // VR_Draw::plus_tex); if (menu_highlight_index == 2) { 	VR_Draw::set_color(c_menu_white);
        //}
        ///* index = 6 */
        ///* index = 7 (exit region) */
        ///* index = 5 */
        ...
        //}
        // VR_Draw::update_modelview_matrix(&m, 0);
        // VR_Draw::render_rect(-0.007f, 0.007f, 0.007f, -0.007f, 0.001f, 1.0f, 1.0f,
        // VR_Draw::minus_tex); if (menu_highlight_index == 1) { 	VR_Draw::set_color(c_menu_white);
        //}
        ///* index = 3 */
        ///* Center */
        //*((Coord3Df*)t_icon.m[3]) = p8_stick;
        // m = t_icon * t;
        // VR_Draw::update_modelview_matrix(&m, 0);
        // VR_Draw::render_string(menu_str.c_str(), 0.009f, 0.012f, VR_HALIGN_CENTER,
        // VR_VALIGN_TOP, 0.0f, 0.005f, 0.001f);
        break;
      }
      case MENUTYPE_SWITCHTOOL: {
        ...
        *((Coord3Df *)t_icon.m[3]) = p12_4;
        ...
        VR_Draw::update_modelview_matrix(&m, 0);
        VR_Draw::render_rect(
            -0.007f, 0.007f, 0.007f, -0.007f, 0.001f, 1.0f, 1.0f, VR_Draw::annotate_tex);
        if (type == TYPE_ANNOTATE) {
          VR_Draw::set_color(c_menu_white);
        }
        else if (menu_highlight_index == 4) {
        ...
        *((Coord3Df *)t_icon.m[3]) = p12_6;
        ...
        VR_Draw::update_modelview_matrix(&m, 0);
        VR_Draw::render_rect(
            -0.007f, 0.007f, 0.007f, -0.007f, 0.001f, 1.0f, 1.0f, VR_Draw::measure_tex);
        if (type == TYPE_MEASURE) {
          VR_Draw::set_color(c_menu_white);
        }
        else if (menu_highlight_index == 6) {
        ...
        *((Coord3Df *)t_icon.m[3]) = p12_8;
        ...
        VR_Draw::update_modelview_matrix(&m, 0);
        VR_Draw::render_rect(
            -0.009f, 0.009f, 0.009f, -0.009f, 0.001f, 1.0f, 1.0f, VR_Draw::bevel_tex);
        if (type == TYPE_BEVEL) {
          VR_Draw::set_color(c_menu_white);
        }
        else if (menu_highlight_index == 8) {
        ...
        *((Coord3Df *)t_icon.m[3]) = p12_10;
        ...
        VR_Draw::update_modelview_matrix(&m, 0);
        VR_Draw::render_rect(
            -0.009f, 0.009f, 0.009f, -0.009f, 0.001f, 1.0f, 1.0f, VR_Draw::knife_tex);
        if (type == TYPE_KNIFE) {
          VR_Draw::set_color(c_menu_white);
        }
        else if (menu_highlight_index == 10) {
        ...
        *((Coord3Df *)t_icon.m[3]) = p12_9;
        ...
        VR_Draw::update_modelview_matrix(&m, 0);
        VR_Draw::render_rect(
            -0.009f, 0.009f, 0.009f, -0.009f, 0.001f, 1.0f, 1.0f, VR_Draw::loopcut_tex);
        if (type == TYPE_LOOPCUT) {
          VR_Draw::set_color(c_menu_white);
        }
        else if (menu_highlight_index == 9) {
        ...
        *((Coord3Df *)t_icon.m[3]) = p12_7;
        ...
        VR_Draw::update_modelview_matrix(&m, 0);
        VR_Draw::render_rect(
            -0.011f, 0.011f, 0.011f, -0.011f, 0.001f, 1.0f, 1.0f, VR_Draw::insetfaces_tex);
        if (type == TYPE_INSETFACES) {
          VR_Draw::set_color(c_menu_white);
        }
        else if (menu_highlight_index == 7) {
        ...
        *((Coord3Df *)t_icon.m[3]) = p12_1;
        ...
        VR_Draw::update_modelview_matrix(&m, 0);
        VR_Draw::render_rect(
            -0.011f, 0.011f, 0.011f, -0.011f, 0.001f, 1.0f, 1.0f, VR_Draw::mesh_tex);
        if (type == TYPE_ADDPRIMITIVE) {
          VR_Draw::set_color(c_menu_white);
        }
        else if (menu_highlight_index == 1) {
        ...
        *((Coord3Df *)t_icon.m[3]) = p12_5;
        ...
        VR_Draw::update_modelview_matrix(&m, 0);
        VR_Draw::render_rect(
            -0.007f, 0.007f, 0.007f, -0.007f, 0.001f, 1.0f, 1.0f, VR_Draw::select_tex);
        if (type == TYPE_SELECT) {
          VR_Draw::set_color(c_menu_white);
        }
        else if (menu_highlight_index == 5) {
        ...
        *((Coord3Df *)t_icon.m[3]) = p12_3;
        ...
        VR_Draw::update_modelview_matrix(&m, 0);
        VR_Draw::render_rect(
            -0.007f, 0.007f, 0.007f, -0.007f, 0.001f, 1.0f, 1.0f, VR_Draw::cursor_tex);
        if (type == TYPE_CURSOR) {
          VR_Draw::set_color(c_menu_white);
        }
        else if (menu_highlight_index == 3) {
      ...
      case MENUTYPE_MAIN_8: {
        ...
        *((Coord3Df *)t_icon.m[3]) = p8_0;
        ...
        VR_Draw::update_modelview_matrix(&m, 0);
        VR_Draw::render_rect(
            -0.009f, 0.009f, 0.009f, -0.009f, 0.001f, 1.0f, 1.0f, VR_Draw::alt_tex);
        if (menu_highlight_index == 0) {
          VR_Draw::set_color(c_menu_white);
        }
        /* index = 4 */
        ...
        *((Coord3Df *)t_icon.m[3]) = p8_2;
        ...
        VR_Draw::update_modelview_matrix(&m, 0);
        VR_Draw::render_rect(
            -0.009f, 0.009f, 0.009f, -0.009f, 0.001f, 1.0f, 1.0f, VR_Draw::redo_tex);
        if (menu_highlight_index == 2) {
          VR_Draw::set_color(c_menu_white);
        }
        /* index = 6 */
        ...
        *((Coord3Df *)t_icon.m[3]) = p8_6;
        ...
        VR_Draw::update_modelview_matrix(&m, 0);
        VR_Draw::render_rect(
            -0.009f, 0.009f, 0.009f, -0.009f, 0.001f, 1.0f, 1.0f, VR_Draw::duplicate_tex);
        if (menu_highlight_index == 6) {
          VR_Draw::set_color(c_menu_white);
        }
        /* index = 7 (exit region) */
        ...
        *((Coord3Df *)t_icon.m[3]) = p8_5;
        ...
        VR_Draw::update_modelview_matrix(&m, 0);
        VR_Draw::render_rect(
            -0.009f, 0.009f, 0.009f, -0.009f, 0.001f, 1.0f, 1.0f, VR_Draw::delete_tex);
        if (menu_highlight_index == 5) {
          VR_Draw::set_color(c_menu_white);
        }
        /* index = 1 */
        ...
        *((Coord3Df *)t_icon.m[3]) = p8_1;
        ...
        VR_Draw::update_modelview_matrix(&m, 0);
        VR_Draw::render_rect(
            -0.009f, 0.009f, 0.009f, -0.009f, 0.001f, 1.0f, 1.0f, VR_Draw::undo_tex);
        if (menu_highlight_index == 1) {
          VR_Draw::set_color(c_menu_white);
        }
        /* index = 3 */
        ...
        *((Coord3Df *)t_icon.m[3]) = p8_3;
        ...
        VR_Draw::update_modelview_matrix(&m, 0);
        VR_Draw::render_rect(
            -0.009f, 0.009f, 0.009f, -0.009f, 0.001f, 1.0f, 1.0f, VR_Draw::object_tex);
        if (menu_highlight_index == 3) {
          VR_Draw::set_color(c_menu_white);
        }
        /* Center */
...
void Widget_Menu::Left::render_icon(const Mat44f &t,
...
void Widget_Menu::Right::render_icon(const Mat44f &t,
                                     VR_Side controller_side,
                                     bool active,
                                     bool touched)
{
