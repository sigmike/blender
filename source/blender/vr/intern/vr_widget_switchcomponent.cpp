...
void Widget_SwitchComponent::render_icon(const Mat44f &t,
  ...
  if (CTX_data_edit_object(C)) {
    switch (mode) {
      case SCE_SELECT_VERTEX: {
        VR_Draw::render_rect(
            -0.008f, 0.008f, 0.008f, -0.008f, 0.001f, 1.0f, 1.0f, VR_Draw::vertex_tex);
        break;
      }
      case SCE_SELECT_EDGE: {
        VR_Draw::render_rect(
            -0.008f, 0.008f, 0.008f, -0.008f, 0.001f, 1.0f, 1.0f, VR_Draw::edge_tex);
        break;
      }
      case SCE_SELECT_FACE: {
        VR_Draw::render_rect(
            -0.008f, 0.008f, 0.008f, -0.008f, 0.001f, 1.0f, 1.0f, VR_Draw::face_tex);
        break;
      }
      default: {
        //
    ...
    VR_Draw::render_rect(
        -0.008f, 0.008f, 0.008f, -0.008f, 0.001f, 1.0f, 1.0f, VR_Draw::object_tex);
  }
}
