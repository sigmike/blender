...
class Widget_Menu : public VR_Widget {
  ...
  static uint
      depth[VR_SIDES]; /* The current menu depth (0 = base menu, 1 = first submenu, etc.). */
 ...
 public:
  ...
  static void stick_center_click(
      VR_UI::Cursor &c); /* Execute operation on stick/dpad center click. */
