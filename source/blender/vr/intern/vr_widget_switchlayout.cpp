...
void Widget_SwitchLayout::render_icon(const Mat44f &t,
                                      ...
                                      bool touched)
{
  ...
  if (CTX_data_edit_object(vr_get_obj()->ctx)) {
    VR_Draw::render_rect(
        -0.008f, 0.008f, 0.008f, -0.008f, 0.001f, 1.0f, 1.0f, VR_Draw::editmode_tex);
  }
  else {
    VR_Draw::render_rect(
        -0.008f, 0.008f, 0.008f, -0.008f, 0.001f, 1.0f, 1.0f, VR_Draw::objectmode_tex);
  }
}
