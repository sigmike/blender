...
/* Interaction widget for navigation: selects the respective sub-widget based on the setting
 * VR_UI::navigation_mode. */
class Widget_Navi : public VR_Widget {
 ...
 public:
  ...
  virtual void drag_start(
      VR_UI::Cursor &c) override; /* Start a drag/hold-motion with the navigation button. */
  virtual void drag_contd(
      VR_UI::Cursor &c) override; /* Continue drag/hold with the navigation button. */
  virtual void drag_stop(
      VR_UI::Cursor &c) override; /* Stop drag/hold with the  navigation button. */
