...
class Widget_Annotate : public VR_Widget {
  ...
  static uint num_layers;   /* The number of VR gpencil layers (one layer for each color + measure
                               tool layer). */
  ...
  static void erase_stroke(bGPDstroke *gps,
                           bGPDframe *gp_frame); /*	Helper function to erase a stroke. */
 public:
