...
const VR_Widget_Layout::Layout VR_Widget_Layout::default_layouts[VR_UI_TYPES][DEFAULTLAYOUTS]{
     ...
     ********************************************/
    {
        ...
        {std::string("Modeling"),
         ...
         {/* VR_SIDE_LEFT */
          BUTTONBIT_NONE,
          /* VR_SIDE_RIGHT */
          BUTTONBIT_NONE}} /* DefaultLayout_Modeling */
    }                      /* Type_Null */
    ,
    /********************************************
     *			   VR_UI_Type_Oculus			*
     ********************************************/
    {
        ...
        {std::string("Modeling"),
         ...
         {                                                  /* VR_SIDE_LEFT */
          {                                                 // BUTTONID_TRIGGER
           {                                                // Alt_Off
            VR_Widget::get_widget(VR_Widget::TYPE_SELECT),  // Alt_On
            VR_Widget::get_widget(VR_Widget::TYPE_MEASURE)},
           // BUTTONID_GRIP
           {                                              // Alt_Off
            VR_Widget::get_widget(VR_Widget::TYPE_NAVI),  // Alt_On
           ...
           // BUTTONID_STICKLEFT
           {                                                // Alt_Off
            VR_Widget::get_widget(VR_Widget::TYPE_DELETE),  // Alt_On
            (VR_Widget *)0},
           // BUTTONID_STICKRIGHT
           {                                                   // Alt_Off
            VR_Widget::get_widget(VR_Widget::TYPE_DUPLICATE),  // Alt_On
            (VR_Widget *)0},
           // BUTTONID_STICKUP
           {                                                    // Alt_Off
            VR_Widget::get_widget(VR_Widget::TYPE_SWITCHTOOL),  // Alt_On
            VR_Widget::get_widget(VR_Widget::TYPE_SWITCHTOOL)},
           // BUTTONID_STICKDOWN
           {                                                   // Alt_Off
            VR_Widget::get_widget(VR_Widget::TYPE_MENU_LEFT),  // Alt_On
            VR_Widget::get_widget(VR_Widget::TYPE_MENU_LEFT)},
           // BUTTONID_STICK
           {                                                         // Alt_Off
            VR_Widget::get_widget(VR_Widget::TYPE_SWITCHCOMPONENT),  // Alt_On
           ...
           // BUTTONID_XA
           {                                               // Alt_Off
            VR_Widget::get_widget(VR_Widget::TYPE_SHIFT),  // Alt_On
            VR_Widget::get_widget(VR_Widget::TYPE_SHIFT)},
           // BUTTONID_YB
           {                                                       // Alt_Off
            VR_Widget::get_widget(VR_Widget::TYPE_NAVI_JOYSTICK),  // Alt_On
          ...
          {                                                    // BUTTONID_TRIGGER
           {                                                   // Alt_Off
            VR_Widget::get_widget(VR_Widget::TYPE_TRANSFORM),  // Alt_On
           ...
           // BUTTONID_STICKLEFT
           {                                              // Alt_Off
            VR_Widget::get_widget(VR_Widget::TYPE_UNDO),  // Alt_On
            (VR_Widget *)0},
           // BUTTONID_STICKRIGHT
           {                                              // Alt_Off
            VR_Widget::get_widget(VR_Widget::TYPE_REDO),  // Alt_On
            (VR_Widget *)0},
           // BUTTONID_STICKUP
           {                                                    // Alt_Off
            VR_Widget::get_widget(VR_Widget::TYPE_SWITCHTOOL),  // Alt_On
           ...
           // BUTTONID_STICKDOWN
           {                                                    // Alt_Off
            VR_Widget::get_widget(VR_Widget::TYPE_MENU_RIGHT),  // Alt_On
            VR_Widget::get_widget(VR_Widget::TYPE_MENU_RIGHT)},
           // BUTTONID_STICK
           {                                                     // Alt_Off
            VR_Widget::get_widget(VR_Widget::TYPE_SWITCHSPACE),  // Alt_On
           ...
           // BUTTONID_XA
           {                                              // Alt_Off
            VR_Widget::get_widget(VR_Widget::TYPE_CTRL),  // Alt_On
            VR_Widget::get_widget(VR_Widget::TYPE_CTRL)},
           // BUTTONID_YB
           {                                                       // Alt_Off
            VR_Widget::get_widget(VR_Widget::TYPE_NAVI_TELEPORT),  // Alt_On
     ...
     ********************************************/
    {
        ...
        {std::string("Modeling"),
         ...
         {                       /* VR_SIDE_LEFT */
          {                      // Alt_Off
           BUTTONBIT_DPADRIGHT,  // Alt_On
           BUTTONBIT_DPADRIGHT},
          /* VR_SIDE_RIGHT */
          {                     // Alt_Off
           BUTTONBIT_DPADLEFT,  // Alt_On
           BUTTONBIT_DPADLEFT}},
         /* ButtonBit shift_button_bits[VR_SIDES][ALTSTATES] */
         {                      /* VR_SIDE_LEFT */
          {                     // Alt_Off
...
VR_UI::Error VR_Widget_Layout::set_current_layout(const std::string &layout_name)
{
  ...
  if (!layout) {
    ...
    layout->m[VR_SIDE_RIGHT][BUTTONID_TRIGGER][0] = VR_Widget::get_widget(
        VR_Widget::TYPE_TRANSFORM);
...
VR_UI::Error VR_Widget_Layout::map_widget(VR_Side side,
                                          std::string event,
                                          VR_UI::AltState alt,
                                          std::string widget)
{
  ...
  if (current_layout->m[side][btn][alt] == VR_Widget::get_widget(VR_Widget::TYPE_CTRL)) {
    ...
    current_layout->ctrl_button_bits[side][alt] = ButtonBit(
        current_layout->ctrl_button_bits[side][alt] & (~bit));
  }
  if (current_layout->m[side][btn][alt] == VR_Widget::get_widget(VR_Widget::TYPE_SHIFT)) {
    ButtonBit bit = buttonIDToBit(btn);
    current_layout->shift_button_bits[side][alt] = ButtonBit(
        current_layout->shift_button_bits[side][alt] & (~bit));
  }
  if (current_layout->m[side][btn][alt] == VR_Widget::get_widget(VR_Widget::TYPE_ALT)) {
    ButtonBit bit = buttonIDToBit(btn);
    current_layout->alt_button_bits[side] = ButtonBit(current_layout->alt_button_bits[side] &
                                                      (~bit));
  }
...
VR_UI::Error VR_Widget_Layout::get_mapped_widget(VR_Side side,
...
VR_UI::Error VR_Widget_Layout::get_mapped_event(const std::string &widget,
                                                VR_Side &side,
                                                std::string &event,
                                                VR_UI::AltState &alt)
{
...
VR_UI::Error VR_Widget_Layout::get_mapped_event(const VR_Widget *widget,
                                                VR_Side &side,
                                                std::string &event,
                                                VR_UI::AltState &alt)
{
...
VR_UI::Error VR_Widget_Layout::get_mapped_event(const Layout *layout,
