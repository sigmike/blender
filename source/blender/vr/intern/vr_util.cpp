                                       ...
                                       const eV3DProjTest flag)
{
  ...
  if (((flag & V3D_PROJ_TEST_CLIP_ZERO) == 0) ||
      (fabsf(vec4[3]) > WIDGET_SELECT_RAYCAST_ZERO_CLIP)) {
...
void VR_Util::raycast_select_single_vertex(const Coord3Df &p,
                                           ViewContext *vc,
                                           bool extend,
                                           bool deselect)
{
  ...
  if (is_inside && sv) {
    ...
    const int sel_op_result = ED_select_op_action_deselected(
        deselect ? SEL_OP_SUB : SEL_OP_SET, is_select, is_inside);
    if (sel_op_result != -1) {
      if (!extend && !deselect) {
...
void VR_Util::raycast_select_single_edge(const Coord3Df &p,
                                         ViewContext *vc,
                                         bool extend,
                                         bool deselect)
{
...
void VR_Util::raycast_select_single_face(const Coord3Df &p,
                                         ViewContext *vc,
                                         bool extend,
                                         bool deselect)
{
...
void VR_Util::raycast_select_single_edit(
    const Coord3Df &p, bool extend, bool deselect, bool toggle, bool enumerate)
{
...
void VR_Util::raycast_select_single(const Coord3Df &p,
                                    bool extend,
                                    bool deselect,
                                    bool toggle,
                                    bool enumerate,
