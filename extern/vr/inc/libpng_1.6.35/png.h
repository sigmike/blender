...
PNG_EXPORTA(
    94, png_voidp, png_malloc, (png_const_structrp png_ptr, png_alloc_size_t size), PNG_ALLOCATED);
/* Added at libpng version 1.4.0 */
PNG_EXPORTA(
    95, png_voidp, png_calloc, (png_const_structrp png_ptr, png_alloc_size_t size), PNG_ALLOCATED);
...
PNG_EXPORTA(
    101, void, png_free_default, (png_const_structrp png_ptr, png_voidp ptr), PNG_DEPRECATED);
#  endif
...
#    define png_composite(composite, fg, alpha, bg) \
      (composite) = (png_byte)( \
          0xff & (((png_uint_16)(fg) * (png_uint_16)(alpha) + \
...
#    define PNG_get_int_32(buf) \
      ((png_int_32)((*(buf)&0x80) ? -((png_int_32)(((png_get_uint_32(buf) ^ 0xffffffffU) + 1U) & \
                                                   0x7fffffffU)) : \
...
#      define png_image_write_get_memory_size( \
        ...
        png_image_write_to_memory( \
            &(image), 0, &(size), convert_to_8_bit, buffer, row_stride, colormap)
